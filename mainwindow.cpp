...
void MainWindow::on_comboBox_events_currentIndexChanged(int index)
{
    ui->lineEdit_prix->setText(ui->comboBox_events->model()->data(ui->comboBox_events->model()->index(index,5)).toString());

}

void MainWindow::on_comboBox_events_2_currentIndexChanged(int index)
{
...
void MainWindow::on_pushButton_remb_clicked()
{
...
void MainWindow::on_comboBox_remb_currentIndexChanged(int index)
{
...
void MainWindow::on_spinBox_remb_valueChanged(int arg1)
{
...
void MainWindow::bilan(int annee){
    QSqlQuery query;
    QSqlQuery query1;
